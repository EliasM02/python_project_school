...
def steg4():
    skattetabell = []
    with open(
        os.path.join(BASE_DIR, "skattetabell.csv"), 
        "r",
        encoding = "utf-8"
    ) as file:                                       #utf-8 för tillgång till bokstäver som å,ä,ö
...
def steg5():
    arbtimmar = []
    with open(
        os.path.join(BASE_DIR, "Arbetstimmar.csv"),
        "r", 
        encoding = "utf-8"
    ) as file:
